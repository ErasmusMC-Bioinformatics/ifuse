<?php
  if (file_exists($this->fileName)) {
   ...
   <?php
              ...
              $this->ifuseloader->organize($this->ifuseloader->getData(!is_dir($seqDir)));
...
Hierna pagiation, en dan ook pas de sequenties laden... Momenteel worden de sequenties altijd geladen...??????
          ...
          <ul id="contextmenu<?php echo($i); ?>" class="jqcontextmenu">
                          ...
                          <ul>
                              ...
                              <li><a>Event Type</a>
                                  <ul>
                                      ...
                                      <li><a href="<?php echo(filterURL('only', 'Single.Event', 'inversion or translocation')); ?>">Inversion or Translocation</a></li>
                                  </ul>
                              </li>
                              <li><a>Gene Orientation</a>
                                  <ul>
                                      <li><a href="<?php echo(filterURL('only' , 'Fusion.Gene', 'same orientation')); ?>">Same orientation</a></li>
                                      <li><a href="<?php echo(filterURL('only', 'Fusion.Gene', 'opposing')); ?>">Opposing</a></li>
                                  </ul>
                              </li>
              ...
              <li onmouseover="createHelp(this,'Sort events using different parameters')"><a>Sort</a>
                  <ul>
                      ...
                      <li><a href="<?php echo(filterURL('sort', 'Gene.Mismatch'                               , 'DSC')); ?>">By Gene Mismatch</a></li>
                      <li><a href="<?php echo(filterURL('sort', 'Single.Event'                                , 'ASC')); ?>">By Event Type</a></li>
                      <li><a href="<?php echo(filterURL('sort', 'Fusion.Gene'                                 , 'DSC')); ?>">By Gene Orientation</a></li>
